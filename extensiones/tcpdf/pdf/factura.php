...
<table>
		...
		<tr>
			...
			<td style="width:540px hight: 400px"><img src="images/back.jpg"></td>
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			<td style="border: 1px solid #666; background-color:white; width:390px">Vendedor: $respuestaVendedor[nombre]
            </td>
            
            <td style="border: 1px solid #666; background-color:white; width:150px">

				NIT: $respuestaCliente[documento]
		...
		<td style="border-bottom: 0.5px solid #666; background-color:white; width:540px"></td>
...
$bloque3 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<td style="border: 1px solid #666; background-color:white; width:95px; text-align:center">Valor Unit.</td>
		<td style="border: 1px solid #666; background-color:white; width:95px; text-align:center">Valor Total</td>
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			<td style="border: 1px solid #666; background-color:white; width:200px; text-align:center">
				esta factura cambiaria a compraventa se asimila en todos sus efectos legales a la letra de cambio segun art. 774 del codigo de comercio.
			</td>
